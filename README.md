...
클라우드 비종속 AI 에이전트 런타임. 9개 LLM 백엔드를 CircuitBreaker로 자동 전환. 141종 노드 워크플로우 엔진, 8역할 에이전트 팀, AES-256-GCM Vault.
...
Claude Code 훅 기반 이중 AI 감사. 코드 변경마다 외부 AI(GPT/Codex)가 독립 검증. 합의 없으면 커밋 차단.
